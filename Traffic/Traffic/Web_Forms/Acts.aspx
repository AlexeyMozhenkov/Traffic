<%@ Page Title="Акты выполнения работ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Acts.aspx.cs" Inherits="Traffic.Acts" %>

<%@ Register Src="~/Web_Controls/ActsControl.ascx" TagPrefix="uc1" TagName="DetailedInfo" %>
        ...
        <asp:MultiView ID="mv_Main" runat="server" ActiveViewIndex="0">
            <asp:View ID="view_DataGrid" runat="server">
                ...
                <div id="modify">
                    ...
                    <br />
                    <asp:Button ID="btn_GetFile" runat="server" Text="Print Act" Width="120px" CssClass="btnAlign"
