...
{
    public class RequestTamplate : BaseWordTemplate, IWordTemplate
    {
        private const string FileName = "Request.dotx";
        public RequestTamplate() : base(FileName) { }
        public RequestTamplate(string folder) : base(Path.Combine(folder, FileName)) { }
