...
{
    public class OrganizationCardTamplate : BaseWordTemplate, IWordTemplate
    {
        private const string FileName = "OrganizationCard.dotx";
        public OrganizationCardTamplate() : base(FileName) { }
        public OrganizationCardTamplate(string folder) : base(Path.Combine(folder, FileName)) { }
