...
<asp:Table ID="Table1" runat="server" HorizontalAlign="Left" BorderColor="#999999"
    ...
    <asp:TableRow runat="server">
        ...
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_1" runat="server" Text="ID Обслуживания"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            ...
            <asp:RequiredFieldValidator ID="vldr_1" runat="server" ErrorMessage="ID Обслуживания: поле не заполнено"
                Text="*" ControlToValidate="txt_1" Display="Static" Enabled="True"></asp:RequiredFieldValidator>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_2" runat="server" Text="ID Транспорта"
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            <asp:RequiredFieldValidator ID="vldr_2" runat="server" ErrorMessage="ID Транспорта: поле не заполнено"
                Text="*" Display="Static" ControlToValidate="txt_2"></asp:RequiredFieldValidator>

        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_3" runat="server" Text="Дата начала"></asp:Label>

        </asp:TableCell>

        <asp:TableCell runat="server">

            <asp:TextBox ID="txt_3" runat="server" Width="200px" TextMode="Date"></asp:TextBox>
        </asp:TableCell>

        <asp:TableCell runat="server" ForeColor="#CC0000">

            <asp:RequiredFieldValidator ID="vldr_3" runat="server" ErrorMessage="Дата начала: поле не заполнено"
                Text="*" ControlToValidate="txt_3" Display="Static" Enabled="True"></asp:RequiredFieldValidator>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
    ...
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_5" runat="server" Text="Номер операции"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            <asp:RequiredFieldValidator ID="vldr_5" runat="server" ErrorMessage="Номер операции: поле не заполнено"
    ...
    <asp:TableRow runat="server">
        ...
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_6" runat="server" Text="Стоимость"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            ...
            <asp:RequiredFieldValidator ID="vldr_6" runat="server" ErrorMessage="Стоимость: поле не заполнено"
                Text="*" ControlToValidate="txt_6" Display="Static" Enabled="True"></asp:RequiredFieldValidator>
        </asp:TableCell>
    </asp:TableRow>
